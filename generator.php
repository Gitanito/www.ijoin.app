...
<body class="text-gray-800 bg-gray-50 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="//a.{$brandName}.app" class="bg-[#0c2664] hover:bg-[#0a1f52] text-white font-medium py-2 px-5 rounded-full transition shadow-lg transform hover:-translate-y-0.5 whitespace-nowrap">
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                <div class="lg:col-span-6 text-center lg:text-left">
                    ...
                    <div class="mt-8 flex justify-center lg:justify-start gap-4">
                        <a href="//a.{$brandName}.app" class="px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#0c2664] hover:bg-[#0a1f52] md:text-lg md:px-10 shadow-xl transition">
    ...
    <div class="hero-gradient">
        <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <a href="//a.{$brandName}.app" class="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-[#0c2664] bg-white hover:bg-gray-50 sm:w-auto transition shadow-lg">
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h3 class="text-2xl font-semibold text-gray-400 tracking-wider uppercase mb-6">{$currentTrans['sup_h']}</h3>
            <div class="flex flex-wrap justify-center gap-8 md:gap-12 opacity-75">
                ...
                <a target="_blank" href="https://www.hot100.ai" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">hot100</a>
                <a target="_blank" href="https://dang.ai/" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">Dang AI</a>
                <a target="_blank" href="https://www.saashub.com/" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">SaaSHub</a>
                <a target="_blank" href="https://betalist.com" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">BetaList</a>
                <a target="_blank" href="https://alternative.me" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">Alternative.me</a>
                <a target="_blank" href="https://futuretools.io" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">Future Tools</a>
                <a target="_blank" href="https://devhunt.org" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">DevHunt</a>
                <a target="_blank" href="https://toolsfine.com" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">toolsfine</a>
                <a target="_blank" href="https://open-launch.com/" class="w-full inline-flex items-center justify-center px-5 py-3 border border-black text-base text-2xl font-black rounded-md text-black bg-white hover:bg-gray-50 sm:w-auto transition">Open Launch</a>
            </div>
        </div>
    </section>
